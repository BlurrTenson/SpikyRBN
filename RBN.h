...
public:
	...
	void ResetLivelinessCountersTemp();
	...
	int GetCycle1LivelinessTempPtr(int);
...
private:
	...
	std::map<int, int> nodeLivelinessTransTemp;
	std::map<int, int> nodeLivelinessCycleTemp;
